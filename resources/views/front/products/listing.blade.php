        ...
        <div class="tab-pane" id="listView">
            <div class="row">
                ...
                <div class="span4">
                    <h3>New | Available</h3>
                    <hr class="soft"/>
                    <h5>{{$categoryDetails['catDetails']['category_name']}} </h5>
                    <p>
                    ...
                    <div class="thumbnail">
                        ...
                        <div class="caption">
                            ...
                            <h4 style="text-align:center">
                                <a class="btn" href="product_details.html"> <i class="icon-zoom-in"></i></a> <a class="btn" href="#">Add to <i class="icon-shopping-cart"></i></a> <a class="btn btn-primary" href="#">{{$product['product_price']}}</a></h4>
                        </div>
                    </div>
                </li>
                @endforeach
